            ...
            <div className={Styles.middleContainer}>
                <div className={Styles.middleMenuSelection}>
                    ...
                    <div className={Styles.linkContainer}>
                        ...
                        <Link className={Styles.link} href="/admin/ManageFinance">
                        ...
                        <Link className={Styles.link} href="/admin/ManageOrders?date=true">
                        ...
                        <Link className={Styles.link} href="/admin/ManageHubs">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" className={Styles.svg}>
