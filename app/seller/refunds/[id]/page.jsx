...
const Refund = async ({ params }) => {
  ...
  // console.log(oneRefund.ORDERS_T.SHIPPING_T);
  // console.log(oneRefund.ORDERS_T.SHIPPING_T[0].shipped_date);

  const order = oneRefund.ORDERS_T;
  const buyer = order.buyer;
  const orderItem = order.ORDER_ITEMS_T;
  const shipping = order.SHIPPING_T[0];
  ...
  if (
    oneRefund.admin_status === "Approved" ||
    oneRefund.admin_status === "Rejected"
  ) {
    status = oneRefund.admin_status + " by admin";
    isResponse = true;
    statStyle = oneRefund.admin_status;
  } else if (
    oneRefund.seller_status === "Approved" ||
    oneRefund.seller_status === "Rejected"
  ) {
  ...
  return (
    <div className={styles.fcon}>
      ...
      <form action={RefundAction} className={styles.fcon}>
        ...
        <input type="hidden" name="seller_remarks" className={styles.remark} />
        ...
        <div className={styles.upCon}>
          <div className={styles.actionContainer}>
            ...
            <a href={`/seller/chat?id=${buyer.user_id}`}>
              <button
                type="button"
      ...
      <br />
      <div className={`${styles.status} ${styles[statStyle]}`}>{status}</div>
          ...
          <div className={styles.splitCard}>
            <div className={styles.timelineSection}>
              ...
              <div className={styles.timeline}>
                ...
                <div className={styles.timelineItem}>
                  <div
                    className={`${styles.timelineDot} ${styles.inactive}`}
                  ></div>
                  <div className={styles.timelineContent}>
                ...
                <div className={styles.productItem} key={index}>
                  ...
                  <div className={styles.productDetails}>
                    <div className={styles.detailRow}>
                      ...
                      <span className={styles.detailDetail}>
