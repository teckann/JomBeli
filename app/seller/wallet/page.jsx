...
import Withdrawal from "@/app/_components/Withdrawal/Withdrawal";

import SellerFilterBar from "@/app/_components/WalletFilterBar/SellerFilterBar";
  ...
  return (
    <main className={styles.main}>
      <div className={styles.div1}>
        <SellerFilterBar availableMonths={availableMonths} />
